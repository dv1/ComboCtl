...
#TODO: It is known that this needs to be called during pairing. However,
it is unclear when and why it would be used beyond that.#
...
Its exact purpose is unknown. So far, it seems that it can be
ignored.

#TODO: Clarify this if possible.#
